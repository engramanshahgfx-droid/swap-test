...
@section('title', 'Verify Reset OTP')
    ...
    <div class="card border-0 shadow-lg">
        <div class="card-body p-5">
            ...
            <div class="test-otp-box">
                ...
                Use this OTP: <code style="font-size: 1.1rem; font-weight: bold; color: #f39c12;">{{ $test_otp }}</code>
            </div>
            @endif

            <form method="POST" action="{{ route('frontend.verify-reset-password-otp') }}">
                @csrf
